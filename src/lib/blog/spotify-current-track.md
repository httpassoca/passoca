...
<Image post="spotify-current-track" img="spotify-integration" alt="Spotify Integration example" maxHeight={740}/>
...
<Image post="spotify-current-track" img="now-playing" alt="example in /about page" maxHeight={228}/>
