...
I'm trying to make my <Link href="https://openclaw.ai"> Clawdbot </Link> send stuff to my Kindle. I was used to the <Link href="https://www.amazon.com/sendtokindle"> Send to Kindle </Link> feature from Amazon itself, but I think it's just a wrapper for sending anything to the Kindle email.
...
I tried, then, using <Link href="https://proton.me/mail"> Proton Mail </Link>. Discovered that they charge money to use IMAP/SMTP. Fine, I'll use one of my Gmail addresses.

So, now I just need to set SMTP, I guess? Asked the claw, he told me that the way is using OAuth with the Gmail API on Google Cloud. Lead the way, Clawd. Lucky me that I already had Cloud kinda configured due to my <Link href="https://github.com/httpassoca/bloodborne-sudoku"> bloodborne-sudoku </Link> project.
