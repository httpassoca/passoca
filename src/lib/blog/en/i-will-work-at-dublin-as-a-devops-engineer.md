---
title: I will work at Dublin as a DevOps Engineer
slug: i-will-work-at-dublin-as-a-devops-engineer
date: 2025-10-18
...
_Eventually._
Since 2023 I started taking on DevOps tasks at my job. At that time, my company was pressuring developers to be not just frontend or backend, but fullstack devs. Ipso factum, I was already in a bad mood because I was working with Angular, which I hate. Now backend too? I even like it, but they use Java, and I don't like Java. That's why I looked into devops tasks. It was a way out of Angular and Java, and a way back to Linux ❤️. So beloved Linux, which I had stopped using because of the same company. Nowadays it is even possible, but 4 years ago it was quite hard to get the VPN working on any linux distro. _Of course, I used WSL in windows, which is basically linux, but c'mon -- is not the full experience._
